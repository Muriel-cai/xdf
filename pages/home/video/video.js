...
Page({
  ...
  exit: function () {
    let self = this;
    console.log(self.data.canExit, "LLLLLLLLLLLLLLLLL1");
    if (self.data.canExit){
      console.log(self.data.canExit,"LLLLLLLLLLLLLLLLL2");
      this.setData({
        canExit:false
      });
      console.log("退出房间————————————————————");
      webrtcroom.quitRoom(self.data.userID, self.data.roomID, function () {
        wx.request({
          url: `${cfg.URL}/rtc/quitRoom`,
          method: "POST",
          data: {
            assignmentId: self.data.assignmentId,
  ...
  createRoom: function () {
    ...
    webrtcroom.createRoom(self.data.userID, this.data.roomname,
      function (res) {
        ...
        console.log("____________________参数————————————————————————", self.data.userID, "____________________参数————————————————————————")
      },
      function (res) {
  ...
  onLoad: function (options) {
    ...
    this.data.roomname = '视频通话';
    this.data.username = options.userName;
    this.setData({
      roomCreator: this.data.userID
    });
    this.joinRoom();
  },
